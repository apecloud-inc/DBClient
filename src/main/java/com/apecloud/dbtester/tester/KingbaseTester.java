...
public class KingbaseTester implements DatabaseTester {
    ...
    private String databaseConnection = "esrep";
    ...
    public DatabaseConnection connect() throws IOException {
        ...
        try {
            ...
            System.err.println("Failed to connect to Kingbase database: " + e );
            System.err.println("Trying with database Kingbase.");
            try {
                return new KingbaseConnection(DriverManager.getConnection(url2, dbConfig.getUser(), dbConfig.getPassword()));
            } catch (SQLException e2) {
                throw new IOException("Failed to connect to Kingbase database: ", e2);
            }
        }
    }
    ...
    private void executeBenchmark(DatabaseConnection connection, String query) throws IOException {
        KingbaseConnection conn = (KingbaseConnection) connection;
    ...
    public static void main(String[] args) throws IOException {
        ...
        DBConfig dbConfig = new DBConfig.Builder()
                ...
                .duration(60)
                .interval(1)
//            .query("select count(*) from table_test;")
